<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MyLikes.aspx.cs" Inherits="MyLikes" %>
...
<asp:Label ID="LabelLikes" runat="server" Text="Your likes:"></asp:Label>
